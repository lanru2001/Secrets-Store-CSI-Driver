...
Below is the diagrammatic workflow of the Secrets Store CSI Driver, which gets secrets from the AWS Secrets Manager and mounts them in a pod.
...
## Step 1: Create an IAM Role/Policy
```bash
